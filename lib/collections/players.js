    ...
    if (countPlayer === 0) {
      console.log("On playerinsert - should only get here the first time you create a new user");
			...
			var player = _.extend(playerAttributes, {
				...
				winD_class: 'countdown_none',
				loseD_class: 'countdown_none',
				tieD_class: 'countdown_none',
				clicked: 'no',
				hal_author: "Hal-9000",
